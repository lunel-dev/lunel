...
const TRANSCRIBE_ENDPOINT = "https://internal-api.jukto.pw/api/transcribe";
  ...
  useEffect(() => {
    if (isVoiceMode) {
      ...
      voiceWaveIntervalRef.current = setInterval(() => {
        let nextLevel = VOICE_WAVE_IDLE_LEVEL;
        ...
        latestVoiceLevelRef.current = nextLevel;
        setVoiceWave((prev) => {
